...
class HostSessionDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.server_input.setPlaceholderText("wss://xml-editor-collab.profiluefter.workers.dev")
        # Placeholder URL - users must deploy their own worker
        self.server_input.setText("wss://xml-editor-collab.profiluefter.workers.dev")
